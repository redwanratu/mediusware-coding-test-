...
const CreateProduct = (props) => {
  ...
  function basic() {
    ...
    const files = acceptedFiles.map((file) => <li key={file.path}> - {file.size} byte </li>);
  }
  ...
  return (
    <div>
      <section>
          ...
          <div className="col-md-6">
            ...
            <div className="card shadow mb-4">
              ...
              <div className="card-body border">
                <Dropzone onDrop={(files) => acceptedFiles(files)} accept="image/*">
                      ...
                      <div className="col-md-4">
                        <div className="form-group">
                          ...
                          <select className="form-control" defaultValue={element.option}>
                            {JSON.parse(props.variants.replaceAll("'", '"')).map(
                              (variant, index) => {
                                return (
        ...
        <button type="button" onClick={saveProduct} className="btn btn-lg btn-primary">
          Save
        </button>
